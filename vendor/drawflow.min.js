    ...
    return function(e) {
        ...
        class i {
            constructor(e, t = null, n = null) {
                ...
                }, this.module = "LeftArm", this.editor_mode = "edit", this.zoom = 1, this.zoom_max = 1.6, this.zoom_min = .5, this.zoom_value = .1, this.zoom_last_value = 1, this.evCache = new Array, this.prevDiff = -1
            }
            start() {
            ...
            click(e) {
                if (this.dispatch("click", e), "fixed" === this.editor_mode) {
                    ...
                    this.ele_selected = e.target.closest(".parent-drawflow"), e.preventDefault()
            ...
            addNodeInput(e) {
                ...
                if (this.module === t) {
                    ...
                    t.classList.add("input"), t.classList.add("input_" + (i + 1));
                    this.container.querySelector("#node-" + e + " .inputs").appendChild(t), this.updateConnectionNodes("node-" + e)
                }
            ...
            addNodeOutput(e) {
                ...
                if (this.module === t) {
                    const t = document.createElement("div");
                    t.classList.add("output"), t.classList.add("output_" + (i + 1));
                    this.container.querySelector("#node-" + e + " .outputs").appendChild(t), this.updateConnectionNodes("node-" + e)
                }
            ...
            removeModule(e) {
                this.module === e && this.changeModule("LeftArm"), delete this.drawflow.drawflow[e], this.dispatch("moduleRemoved", e)
            }
            clearModuleSelected() {
